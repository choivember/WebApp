...
import com.section02.javaconfig.MenuController;
...
public class Application {
    ...
    private static Map<String, String> inputMenu() {
        Scanner sc = new Scanner(System.in);
        System.out.println("새로 등록할 메뉴명을 입력하세요 : ");
    ...
    private static Map<String, String> inputMenuCode() {
        Scanner sc = new Scanner(System.in);
        System.out.println("대상 메뉴 코드를 입력하세요 : ");
    ...
    private static Map<String, String> inputModifyMenu(){
        Scanner sc = new Scanner(System.in);
        System.out.println("수정하고 싶은 메뉴 코드를 입력하세요 : ");
        String code = sc.nextLine();
        System.out.println("메뉴의 수정된 이름을 입력하세요 : ");
        String name = sc.nextLine();
        System.out.println("메뉴의 수정된 가격을 입력하세요 : ");
        String price = sc.nextLine();
        System.out.println("메뉴의 수정된 카테고리 코드를 입력하세요 : ");
        String categoryCode = sc.nextLine();
